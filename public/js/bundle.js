...
(_document$querySelect = document.querySelector('.form')) === null || _document$querySelect === void 0 || _document$querySelect.addEventListener('submit', function (e) {
  var _document, _document2;
  e.preventDefault();

  // VALUES
  var email = (_document = document) === null || _document === void 0 ? void 0 : _document.getElementById('email').value;
  var password = (_document2 = document) === null || _document2 === void 0 ? void 0 : _document2.getElementById('password').value;
